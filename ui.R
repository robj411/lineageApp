                                                      ...
                                                      column(3, id = "menu",
                                                             ...
                                                             div(id = "1.1",
                                                                 div(id = "incidence_data_type_error_box", class = "error_box",
                                                                     ...
                                                                     #, checkboxGroupInput(inputId='ti_DGX', label='Genotypes', choices = parms$geno_labs, selected = NULL)
                                                                     #, checkboxGroupInput(inputId='ti_filename', label='Lineages', choices = parms$labels, selected = parms$labels[1])
